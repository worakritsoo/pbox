<script>
  ...
  async function login(ev) {
    ...
    console.log(data);
    const [L, fname, lastname, ...profile] = data.split(",");
    if (fname && lastname) {
      $usr = { username, fname, lastname, profile };
      console.log($usr);
    }
  }
</script>
...
<body>
  <section class="min-h-screen flex items-stretch text-white ">
    <div
      ...
      style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/LOGO_PEA.jpg/1506px-LOGO_PEA.jpg);"
    >
      <div class="absolute bg-black opacity-60 inset-0 z-0" />
      <div class="w-full px-24 z-10">
        <h1 class="text-5xl font-bold text-left tracking-wide">Pea</h1>
    ...
    >
      ...
      <div class="w-full py-6 z-20">
        ...
        <form on:submit|preventDefault={login} class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
          <div class="pb-2 pt-4">
            <input
              type="text"
              name="username"
